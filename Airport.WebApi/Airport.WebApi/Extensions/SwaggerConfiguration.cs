namespace Airport.WebApi.Extensions
{
    ...
    public static class SwaggerConfiguration
    {
        ...
        public static IServiceCollection ConfigureSwagger(this IServiceCollection services, IConfiguration configs)
        {
            services.AddSwaggerGen(options =>
            {
                options.SwaggerDoc("v1", new Info
                {
                    ...
                    Description = "Airport Web Api",
                    Title = "Airport Web Api",
                    Version = "v1",
                ...
                var xmlPath = Path.Combine(basePath, "Airport.WebApi.xml");
        ...
        public static IApplicationBuilder UseConfiguredSwagger(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(c =>
                {
                    c.DocumentTitle = "Airport Web Api";
                    c.RoutePrefix = "swagger";
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Airport Web Api API");
