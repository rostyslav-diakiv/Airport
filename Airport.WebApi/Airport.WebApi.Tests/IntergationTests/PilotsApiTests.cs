namespace Airport.WebApi.Tests.IntergationTests
{
    ...
    public class PilotsApiTests
    {
        [Collection("Common Server Collection")]
        public class GetPilotsApiTests
        {
            private readonly TestFixture _fixure;
            public GetPilotsApiTests(TestFixture fixture)
            {
                _fixure = fixture;
            }
        ...
        public class UpdatePilotsApiTests
        {
            private readonly TestFixture _fixure;
            public UpdatePilotsApiTests(TestFixture fixture)
            {
                _fixure = fixture;
            }
            ...
            [Fact]
            public async Task UpdateNotExistingPilot_WhenRequestIsValid_ReturnsBadRequest()
            {
                // Arrange
                var pilotIdMock = 1243253;
                var pilot = new PilotRequest()
                                {
                                    Name = "TestCreate",
                                    FamilyName = "CreateTest",
        ...
        [Collection("Common Server Collection")] // TODO: Will be the same server as the Get
        public class DeletePilotsApiTests
        {
            private readonly TestFixture _fixure;
